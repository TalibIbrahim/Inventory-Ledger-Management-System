...
import { Database, Cloud, FolderOpen, Save, RefreshCw, Info } from 'lucide-react';
      ...
      <div className="max-w-3xl mx-auto space-y-8">
          ...
          <div className="p-6 border-b border-slate-100">
            ...
            <div className="mt-4 flex gap-3">
              ...
              <button 
                ...
                className="px-4 py-2.5 bg-white border border-slate-200 rounded-xl text-sm font-medium text-slate-700 hover:bg-slate-50 transition-colors flex items-center gap-2 shadow-xs"
              >
        ...
        <div className="flex justify-end pt-4">
          <button
            onClick={handleSave}
            disabled={isSaving}
            className="px-6 py-2.5 bg-slate-900 text-white rounded-xl text-sm font-medium hover:bg-slate-800 transition-colors flex items-center gap-2 shadow-md shadow-slate-900/10 disabled:opacity-50"
          >
